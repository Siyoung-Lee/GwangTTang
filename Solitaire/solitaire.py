...
game_explain_image = pygame.image.load("game_explain.png")

game_explain_button_image = pygame.image.load("game_explain_button.png")
game_exit_button_image = pygame.image.load("game_exit_button.png")
game_start_button_image = pygame.image.load("game_start_button.png")
...
def game_explain():
    ...
    screen.blit(game_explain_image, [0, 0]);
    pygame.display.flip()
...
def game_intro():
    ...
    while intro:
        ...
        screen.blit(game_start_button_image, [450, 200])
        screen.blit(game_explain_button_image, [450, 330])
        screen.blit(game_exit_button_image, [450, 460])
