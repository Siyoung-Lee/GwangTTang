...
def main():
    ...
    # 카드 좌표 지정
    deck_list = [Suggest_Deck(250, 50), Hidden_Deck(470, 230), Hidden_Deck(590, 230),
                 Hidden_Deck(710, 230), Hidden_Deck(830, 230), Hidden_Deck(950, 230),
                 Collect_Deck(830, 50), Collect_Deck(950, 50)]
    m_card = Moved_card()
